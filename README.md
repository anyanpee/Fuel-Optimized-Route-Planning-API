...
https://images/django_installed_successfully.png
...
https://images/Django_server_running_on_browser.png
...
https://images/django_secret_key_for_api_created.png
...
https://images/migration_for_datalake_success_on_terminal.png

bash
# Run migrations
python manage.py makemigrations
python manage.py migrate
https://images/fuel_data_imported_success_on_terminal.png

Step 5: API Integration Setup
bash
# Install geopy for distance calculations
pip install geopy
https://images/Geopy_installled_successfully.png

bash
# Sign up for OpenRouteService API key
# Visit: https://openrouteservice.org/dev/#/signup
# Add your API key to .env file
https://images/open_route_service_dashboard.png
...
def get_route_geometry(start_coords, end_coords):
    ...
    # Implementation details...
https://images/Api_handling_missing_values_and_filtering_by_states_and_address.png
...
https://images/accessing_fuel_Api_on_browser.png
...
https://images/fuel_price.csv_served_by_django_api_on_browser.png
...
https://images/api_response_with_200_successful_response.png
...
https://images/fuel_price_calculation_success_response_for_state_with_cheapest_fuel.png

https://images/api_postman_response_for_calculating_routes_distance_and_fuel_cost.png
